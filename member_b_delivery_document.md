...
- 左侧边栏导航：个人中心标题、二级菜单（基本信息/发布帖子/草稿箱/我的悬赏/我的关注/我的点赞/我的收藏/积分记录）、底部辅助功能（编辑资料）、最近积分记录模块
...
### 3. 个人中心UI优化
- 侧边栏底部仅保留「编辑资料」按钮，删除「返回首页」和「退出登录」
- 顶部导航栏右上角「退出」改为「首页」按钮（带 home 图标，返回首页）
- 基本信息页面底部增加「退出登录」按钮（红色边框样式，带 sign-out 图标）
